...
print_header('Analytics', get_string('config','service'),nav_upc("<a href=\"index.php\">".get_string('config','service')."</a>"));
if($novisible){
	print_heading(get_string('estatserveis','service'));
	$form->estat_serveis();
}
