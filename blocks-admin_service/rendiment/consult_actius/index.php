...
/// Get all required strings
    ...
    $strconsult = get_string('actius', 'indicadors');
	...
	$form.="<TR>";
	$form.='<TD colspan="3">'.get_string('actius', 'indicadors').'</TD></TR>';
	...
	if (isset ($indform['button'])){
		...
		if (!isset ($ADM->entorn_actual)){
			...
			if (isset ($indform['tot'])){
				...
				$table_consult->head= array (get_string('date', 'indicadors'), get_string('users'));
				$table_consult->wrap = array ('nowrap','');
