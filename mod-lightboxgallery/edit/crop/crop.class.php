...
class edit_crop extends edit_base {
    ...
    function output() {
        global $CFG;
        $result =  '<script type="text/javascript" src="'.$CFG->wwwroot.'/mod/lightboxgallery/scripts/prototype.js"></script>    
                    <script type="text/javascript" src="'.$CFG->wwwroot.'/mod/lightboxgallery/scripts/scriptaculous.js?load=builder,dragdrop"></script>
                    <script type="text/javascript" src="'.$CFG->wwwroot.'/mod/lightboxgallery/scripts/cropper.js"></script>
