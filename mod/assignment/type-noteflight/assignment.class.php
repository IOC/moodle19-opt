...
/**
 * Extend the base assignment class for assignments.  This is roughly a clone of the 'online'
 * assignment type, but the form is slightly different.
 */
class assignment_noteflight extends assignment_base {

    function assignment_noteflight($cmid='staticonly', $assignment=NULL, $cm=NULL, $course=NULL) {
        parent::assignment_base($cmid, $assignment, $cm, $course);
        $this->type = 'noteflight';
    }
...
/// prepare form and process submitted data
        $mform = new mod_assignment_noteflight_edit_form();
...
/// print header, etc. and display form if needed
        ...
        if (has_capability('mod/assignment:submit', $context)) {
            if ($editmode) {
                print_box_start('generalbox', 'noteflight');
                $mform->display();
            } else {
                print_box_start('generalbox boxwidthwide boxaligncenter', 'noteflight');
                if ($submission) {
    ...
    function print_student_answer($userid, $return=false){
        ...
        $output = '<div class="files">'.
                  ...
                  link_to_popup_window ('/mod/assignment/type/noteflight/file.php?id='.$this->cm->id.'&amp;userid='.
...
class mod_assignment_noteflight_edit_form extends moodleform {
    function definition() {
        $mform =& $this->_form;
